...
size_t parameter_correction_0_num_bins_pl_0 = 5;

std::vector<float> parameter_correction_0_edges_pl_0 = {
0.000, 0.524, 0.785, 1.047, 1.309, 1.571,
};


size_t parameter_correction_1_num_bins_pl_0 = 8;

std::vector<float> parameter_correction_1_edges_pl_0 = {
...
size_t parameter_correction_0_num_bins_pl_1 = 5;

std::vector<float> parameter_correction_0_edges_pl_1 = {
0.000, 0.524, 0.785, 1.047, 1.309, 1.571,
};


size_t parameter_correction_1_num_bins_pl_1 = 8;

std::vector<float> parameter_correction_1_edges_pl_1 = {
0.000, 0.196, 0.393, 0.589, 0.785, 0.982, 1.178, 1.374, 1.571,
};
...
size_t parameter_correction_0_num_bins_pl_2 = 5;

std::vector<float> parameter_correction_0_edges_pl_2 = {
0.000, 0.524, 0.785, 1.047, 1.309, 1.571,
};


size_t parameter_correction_1_num_bins_pl_2 = 8;

std::vector<float> parameter_correction_1_edges_pl_2 = {
0.000, 0.196, 0.393, 0.589, 0.785, 0.982, 1.178, 1.374, 1.571,
};
